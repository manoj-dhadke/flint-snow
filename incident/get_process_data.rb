...
@log.info("Starting called flintbit flint-snow:incident:get_process_data.rb")
	...
	data["assignment_group"] = data["assignment_group"]["value"]
        ...
        response = @call.bit("flint-snow:incident:list_assigned_to_user.rb").set("sys-id", data["assigned_to"]).sync
	...
	#@log.info("#{data["assignment_group"]}")
        ...
        response = @call.bit("flint-snow:incident:list_opened_by.rb").set("sys-id", data["opened_by"]).sync
	...
	@log.info("LOCATION ::: #{data["location"]}")
        response = @call.bit("flint-snow:incident:list_location.rb").set("sys-id", data["location"]).sync
	...
	if ((!data["problem_id"].nil?) && (!data["problem_id"]["value"].nil?))
        ...
        response = @call.bit("flint-snow:incident:list_assignmentgroup.rb").set("sys-id", data["requested_by"]).sync
        ...
        response = @call.bit("flint-snow:incident:list_assignmentgroup.rb").set("sys-id", data["std_change_producer_version"]).sync
	...
	@log.info("resolved_by #{data["u_resolver"]}")
        ...
        response = @call.bit("flint-snow:incident:list_business_service.rb").set("sys-id", data["business_service"]).sync
        ...
        response = @call.bit("flint-snow:incident:list_configuration_item.rb").set("sys-id", data["configuration_item"]).sync
	...
	if ((!data["u_service_desk_agent"].nil?) && (!data["u_service_desk_agent"]["value"].nil?))
        ...
        response = @call.bit("flint-snow:incident:list_u_service_desk_agent.rb").set("sys-id", data["u_service_desk_agent"]).sync
        ...
        response = @call.bit("flint-snow:incident:list_resolved_by.rb").set("sys-id", data["resolved_by"]).sync
        data["resolved_by"]=response.get("name")
        end

        if ((!data["rfc"].nil?) && (!data["rfc"]["value"].nil?))
        data["rfc"] = data["rfc"]["value"]
        response = @call.bit("flint-snow:incident:list_rfc.rb").set("sys-id", data["rfc"]).sync
        data["rfc"]=response.get("name")
        end


        response1 = @call.bit("flint-snow:incident:list_activity.rb").set("sys-id",data["sys_id"]).sync
        response2 = @call.bit("flint-snow:incident:list_attachment.rb").set("sys-id",data["sys_id"]).sync
        response3 = @call.bit("flint-snow:incident:list_email.rb").set("sys-id",data["sys_id"]).sync
...
@log.info("Finished executing flint-snow:incident:get_process_data.rb")
