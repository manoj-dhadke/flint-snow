# begin
@log.trace("Started executing 'flint-snow:incident:note_get.rb' flintbit...")
begin
    ...
    if response_exitcode == 0
        ...
        response= @call.bit("flint-snow:incident:note_process_data.rb").setraw(response_body).sync
...
@log.trace("Finished executing 'flint-snow:incident:note_get.rb' flintbit...")
# end
