# begin
@log.trace("Started executing 'flint-snow:incident:list_configuration_list.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:incident:list_configuration_list.rb' flintbit...")
# end
