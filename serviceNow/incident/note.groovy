...
log.trace("Started executing 'flint-util:serviceNow:incident:note.groovy' flintbit...")
try{
   ...
   // data.work_notes = input.get("work_notes")
    ...
    if (response_exitcode == 0){
        ...
        response = call.bit("serviceNow:incident:note_get.groovy").setraw(response_body).sync()
...
log.trace("Finished executing 'flint-util:serviceNow:incident:note.groovy' flintbit...")
// end
