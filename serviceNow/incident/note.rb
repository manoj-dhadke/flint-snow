# begin
@log.trace("Started executing 'serviceNow:incident:note.rb' flintbit...")
begin
...
note :: #{data["work_notes"]}")
  ...
  response_body = response.get('body')# Response body
    ...
    if response_exitcode == 0
        ...
        @call.bit("serviceNow:incident:note_get.rb").setraw(response_body).set('sys-id', @sysid).set('sysparm_display_value', @sysparm_display_value).sync
...
@log.trace("Finished executing 'serviceNow:incident:note.rb' flintbit...")
# end
