...
#post_data = {}
        ...
        response = @call.bit("serviceNow:incident:list_assignmentgroup.rb").set("sys-id", data["assignment_group"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_assigned_to_user.rb").set("sys-id", data["assigned_to"]).sync
        data["assigned_to"]=response.get("name")
				@log.info(data["assignment_group"])
      	end
      	if ((!data["opened_by"].nil?) && (!data["opened_by"]["value"].nil?))
        data["opened_by"] = data["opened_by"]["value"]
        response = @call.bit("serviceNow:incident:list_opened_by.rb").set("sys-id", data["opened_by"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_location.rb").set("sys-id", data["location"]).sync
	...
	if ((!data["problem_id"].nil?) && (!data["problem_id"]["value"].nil?))
        ...
        response = @call.bit("serviceNow:incident:list_assignmentgroup.rb").set("sys-id", data["requested_by"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_assignmentgroup.rb").set("sys-id", data["std_change_producer_version"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_resolved_by.rb").set("sys-id", data["u_resolver_user"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_business_service.rb").set("sys-id", data["business_service"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_configuration_item.rb").set("sys-id", data["configuration_item"]).sync
        ...
        response = @call.bit("serviceNow:incident:list_u_service_desk_agent.rb").set("sys-id", data["u_service_desk_agent"]).sync
