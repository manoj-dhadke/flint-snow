...
@log.trace("Started executing 'flint-util:serviceNow:list_assignmentgroup.rb' flintbit...")
begin
  ...
  #@log.info(response_body)
    ...
    if response_exitcode == 0
	 ...
	 @log.info("Success in executing serviceNow Connector, where exitcode :: #{response_exitcode} | message :: #{response_message}")
       ...
       #  response = @call.bit("serviceNow:incident:process_assignmentgroup.rb").setraw(response_body).sync
...
@log.trace("Finished executing 'flint-util:serviceNow:list_assignmentgroup.rb' flintbit...")
# end
