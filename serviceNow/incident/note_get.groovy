// begin
log.trace("Started executing 'flint-util:serviceNow:incident:note_get.groovy' flintbit...")
try{
    ...
    if (response_exitcode == 0){
        ...
        response = call.bit("serviceNow:incident:note_process_data.groovy").setraw(response_body).sync()
...
log.trace("Finished executing 'flint-util:serviceNow:incident:note_get.groovy' flintbit...")
// end
