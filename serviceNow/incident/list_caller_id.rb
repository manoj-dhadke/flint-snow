@log.trace("Started executing 'flint-util:serviceNow:list_caller_id.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-util:serviceNow:list_caller_id.rb' flintbit...")
# end
