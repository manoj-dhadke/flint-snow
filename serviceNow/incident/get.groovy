// begin
log.trace("Started executing 'flint-util:serviceNow:incident:get.groovy' flintbit...")
try{
...
log.trace("Finished executing 'flint-util:serviceNow:incident:get.groovy' flintbit...")
// end
