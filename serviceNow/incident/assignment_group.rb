# begin
@log.trace("Started executing 'serviceNow:incident:assignment_group.rb' flintbit...")
begin
...
@log.trace("Finished executing 'serviceNow:incident:assignment_group.rb' flintbit...")
# end
