@log.trace("Started executing 'flint-util:serviceNow:list_sys_domain.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-util:serviceNow:list_sys_domain.rb' flintbit...")
# end
