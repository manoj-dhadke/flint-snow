@log.trace("Started executing 'flint-util:serviceNow:list_assigned_to_user.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-util:serviceNow:list_assigned_to_user.rb' flintbit...")
# end
