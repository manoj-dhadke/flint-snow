@log.trace("Started executing 'flint-util:serviceNow:list_opened_by.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-util:serviceNow:list_opened_by.rb' flintbit...")
# end
