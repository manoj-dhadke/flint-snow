# begin
@log.trace("Started executing 'serviceNow:problem:assignment_group.rb' flintbit...")
begin
 ...
 assignment_group :: #{data["assignment_group"]}")
  ...
  response_body = response.get('body')# Response body
    ...
    if response_exitcode == 0
        ...
        @log.info("Assignment Group :: #{data["assignment_group"]}")
...
@log.trace("Finished executing 'serviceNow:problem:assignment_group.rb' flintbit...")
# end
