// begin
log.trace("Started executing 'flint-util:serviceNow:problem:get.groovy' flintbit...")
try{
...
log.trace("Finished executing 'flint-util:serviceNow:problem:get.groovy' flintbit...")
// end
