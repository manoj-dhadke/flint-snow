# begin
@log.trace("Started executing 'serviceNow:incident:close_details.rb' flintbit...")
begin
    ...
    data = {}
    data["state"]= "Closed"
    data["close_notes"]=@input.get('close_notes')
...
@log.trace("Finished executing 'serviceNow:problem:close_details.rb' flintbit...")
# end
