// begin
log.trace("Started executing 'flint-util:serviceNow:problem:update.groovy' flintbit...")
try{
    ...
    if (response_exitcode == 0){
        ...
        response = call.bit("serviceNow:problem:get_process_data.groovy").setraw(response_body).sync()
...
log.trace("Finished executing 'flint-util:serviceNow:problem:update.groovy' flintbit...")
// end
