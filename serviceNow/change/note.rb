# begin
@log.trace("Started executing 'serviceNow:change:note.rb' flintbit...")
begin
...
note :: #{data["work_notes"]}")
  ...
  response_body = response.get('body')# Response body
    ...
    if response_exitcode == 0
        ...
        @call.bit("serviceNow:change:note_get.rb").setraw(response_body).set('sys-id', @sysid).set('sysparm_display_value', @sysparm_display_value).sync
...
@log.trace("Finished executing 'serviceNow:change:note.rb' flintbit...")
# end
