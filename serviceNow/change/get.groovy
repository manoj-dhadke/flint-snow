// begin
log.trace("Started executing 'flint-util:serviceNow:change:get.groovy' flintbit...")
try{
...
log.trace("Finished executing 'flint-util:serviceNow:change:get.groovy' flintbit...")
// end
