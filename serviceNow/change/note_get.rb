# begin
@log.trace("Started executing 'flint-util:serviceNow:change:get.rb' flintbit...")
begin
   ...
   # @log.info("RESPONSE :: #{response_body}")
    if response_exitcode == 0
        ...
        response= @call.bit("serviceNow:change:note_process_data.rb").setraw(response_body).sync 
...
@log.trace("Finished executing 'flint-util:serviceNow:change:get.rb' flintbit...")
# end
