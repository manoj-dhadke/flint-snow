// begin
log.trace("Started executing 'flint-util:serviceNow:change:update.groovy' flintbit...")
try{
    ...
    if (response_exitcode == 0){
        ...
        response = call.bit("serviceNow:change:get_process_data.groovy").setraw(response_body).sync()
...
log.trace("Finished executing 'flint-util:serviceNow:change:update.groovy' flintbit...")
// end
