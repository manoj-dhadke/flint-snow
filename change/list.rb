...
begin
    ...
    sysparm_fields = "sys_id, number, closed_at, priority, incident_state, assigned_to, category ,correlation_id, sys_updated_by, sys_updated_on ,caller_id, assignment_group, short_description, description, cmdb_ci"
