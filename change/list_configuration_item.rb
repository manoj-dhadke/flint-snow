...
# begin
@log.trace("Started executing 'flint-snow:change:list_configuration_item.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:change:list_configuration_item.rb' flintbit...")
# end
