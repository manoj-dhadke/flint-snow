...
# begin
@log.trace("Started executing 'flint-snow:change:list_business_service.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:change:list_business_service.rb' flintbit...")
# end
