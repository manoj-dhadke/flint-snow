...
@log.trace("Started executing 'flint-snow:change:list_assigned_to_user.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:change:list_assigned_to_user.rb' flintbit...")
# end
