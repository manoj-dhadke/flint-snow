...
# begin
@log.trace("Started executing 'flint-snow:change:list_email.rb' flintbit...")
begin
    ...
    if response_exitcode == 0
        ...
        response = @call.bit("flint-snow:change:get_process_email.rb").setraw(response_body).sync 
...
@log.trace("Finished executing 'flint-snow:change:list_email.rb' flintbit...")
# end
