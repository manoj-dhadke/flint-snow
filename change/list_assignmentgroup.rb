...
@log.trace("Started executing 'flint-snow:change:list_assignmentgroup.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:change:list_assignmentgroup.rb' flintbit...")
# end
