...
@log.info("Starting called flintbit change:get_process_data.rb")
   ...
   data = @input.get("result")
	...
	data["assignment_group"] = data["assignment_group"]["value"]
        response = @call.bit("flint-snow:change:list_assignmentgroup.rb").set("sys-id", data["assignment_group"]).sync
        ...
        response = @call.bit("flint-snow:change:list_assigned_to_user.rb").set("sys-id", data["assigned_to"]).sync
	...
	#@log.info(data["assignment_group"])
        ...
        response = @call.bit("flint-snow:change:list_opened_by.rb").set("sys-id", data["opened_by"]).sync
	...
	@log.info("LOCATION ::: #{data["location"]}")
        response = @call.bit("flint-snow:change:list_location.rb").set("sys-id", data["location"]).sync
	...
	if ((!data["problem_id"].nil?) && (!data["problem_id"]["value"].nil?))
        ...
        response = @call.bit("flint-snow:change:list_assignmentgroup.rb").set("sys-id", data["requested_by"]).sync
        ...
        response = @call.bit("flint-snow:change:list_assignmentgroup.rb").set("sys-id", data["std_change_producer_version"]).sync
	...
	#@log.info("resolved_by #{data["u_resolver_user"]}")
        response = @call.bit("flint-snow:change:list_resolved_by.rb").set("sys-id", data["u_resolver_user"]).sync
        ...
        response = @call.bit("flint-snow:change:list_business_service.rb").set("sys-id", data["business_service"]).sync
        ...
        response = @call.bit("flint-snow:change:list_configuration_item.rb").set("sys-id", data["configuration_item"]).sync
	...
	if ((!data["u_service_desk_agent"].nil?) && (!data["u_service_desk_agent"]["value"].nil?))
        ...
        response = @call.bit("flint-snow:change:list_u_service_desk_agent.rb").set("sys-id", data["u_service_desk_agent"]).sync
        ...
        response = @call.bit("flint-snow:change:list_resolved_by.rb").set("sys-id", data["resolved_by"]).sync
        data["resolved_by"]=response.get("name")
        end

        if ((!data["rfc"].nil?) && (!data["rfc"]["value"].nil?))
        data["rfc"] = data["rfc"]["value"]
        response = @call.bit("flint-snow:change:list_rfc.rb").set("sys-id", data["rfc"]).sync
        data["rfc"]=response.get("name")
        end

        response1 = @call.bit("flint-snow:change:list_activity.rb").set("sys-id",data["sys_id"]).sync
        response2 = @call.bit("flint-snow:change:list_attachment.rb").set("sys-id",data["sys_id"]).sync
        response3 = @call.bit("flint-snow:change:list_email.rb").set("sys-id",data["sys_id"]).sync
