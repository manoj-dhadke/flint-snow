# begin
@log.trace("Started executing 'flint-snow:change:note.rb' flintbit...")
begin
    #@log.trace(@input.raw())
    ...
    if response_exitcode == 0
        ...
        response=@call.bit("flint-snow:change:note_get.rb").setraw(response_body).set('sys-id', @sysid).set('sysparm_display_value', @sysparm_display_value).sync
...
@log.trace("Finished executing 'flint-snow:change:note.rb' flintbit...")
# end
