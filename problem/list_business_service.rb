...
# begin
@log.trace("Started executing 'flint-snow:problem:list_business_service.rb' flintbit...")
begin
    ...
    @log.info("BUSINESS SERVICE VALUE :: #{@sysid}")
...
@log.trace("Finished executing 'flint-snow:problem:list_business_service.rb' flintbit...")
# end
