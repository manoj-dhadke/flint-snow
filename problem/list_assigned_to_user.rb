...
@log.trace("Started executing 'flint-snow:problem:list_assigned_to_user.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:list_assigned_to_user.rb' flintbit...")
# end
