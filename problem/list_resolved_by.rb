...
@log.trace("Started executing 'flint-snow:problem:list_resolved_by.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-snow:problem:list_resolved_by.rb' flintbit...")
# end
