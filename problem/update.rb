...
# begin
@log.trace("Started executing 'flint-snow:problem:update.rb' flintbit...")
begin
...
state :: #{data}")
  ...
  response_body = response.get('body')
    ...
    if response_exitcode == 0
        ...
        @log.info("output :: updated sucessfully")
...
@log.trace("Finished executing 'flint-snow:problem:update.rb' flintbit...")
# end
