...
# begin
@log.trace("Started executing 'flint-snow:problem:get.rb' flintbit...")
begin
    ...
    if response_exitcode == 0
        ...
        response = @call.bit("flint-snow:problem:get_process_data.rb").setraw(response_body).sync 
        @output.set('result', response.get('data')).setraw('activity', response.get('activity')).setraw('attachment', response.get('attachment')).set('email', response.get('email'))
...
@log.trace("Finished executing 'flint-snow:problem:get.rb' flintbit...")
# end
